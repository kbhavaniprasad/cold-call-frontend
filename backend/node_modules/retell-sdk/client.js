...
const export_request_1 = require("./resources/export-request.js");
...
const playground_1 = require("./resources/playground.js");
...
class Retell {
    ...
    constructor({ baseURL = (0, env_1.readEnv)('RETELL_BASE_URL'), apiKey = (0, env_1.readEnv)('RETELL_API_KEY'), ...opts } = {}) {
        ...
        this.exportRequest = new API.ExportRequest(this);
        this.batchCall = new API.BatchCall(this);
        this.tests = new API.Tests(this);
        this.playground = new API.Playground(this);
        ...
        const customHeadersEnv = (0, env_1.readEnv)('RETELL_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
...
Retell.ExportRequest = export_request_1.ExportRequest;
Retell.BatchCall = batch_call_1.BatchCall;
Retell.Tests = tests_1.Tests;
Retell.Playground = playground_1.Playground;
